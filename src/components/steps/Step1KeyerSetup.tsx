      ...
      <div className="max-w-xl mx-auto space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex gap-3 justify-center">
            <BigButton variant="secondary" onClick={onTestDit} className="!min-h-[48px] !py-2 !px-6 !text-base">
              Test Dit
            </BigButton>
            <BigButton variant="secondary" onClick={onTestDah} className="!min-h-[48px] !py-2 !px-6 !text-base">
              Test Dah
            </BigButton>
          </div>
